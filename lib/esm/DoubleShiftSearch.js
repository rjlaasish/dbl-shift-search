...
function DoubleShiftSearch(_a) {
    ...
    var _g = useState(isInputActive), isActive = _g[0], setIsActive = _g[1];
    ...
    return (React.createElement("div", { id: "dbl-shift-search-wrapper", "data-testid": "test-dbl-shift-search-wrapper", className: "".concat(isActive ? "container-active" : "", " double-shift-wrapper") },
        leftHelperTextPosition && (React.createElement("span", { "aria-hidden": "false", "aria-label": "left-search-input-label" }, helperText)),
        React.createElement("input", { id: "dbl-shift-search-input", "data-testid": "test-dbl-shift-search-input", ref: inputRef, type: "search", "aria-label": "double-shift-search-input", style: inputStylingProps, className: isActive ? "active" : "", placeholder: isActive ? placeholder : "", onChange: onChange, onBlur: handleDropdownBlur }),
        rightHelperTextPosition && (React.createElement("span", { "aria-hidden": "false", "aria-label": "right-search-input-label" }, helperText))));
}
